  ...
  extends BaseApplicationCustomizer<ISpNavigationApplicationCustomizerProperties> {
    ...
    private _renderPlaceHolders() : void{
              ...
              if(this._topPlaceholder.domElement){
                ...
                <div class="${styles.app}">
                  <div class="ms-bgColor-themeDark ms-fontColor-white ${styles.top}">
                    ...
                    <li class="static "><a target="_blank" href="https://github.com/Narendra-Bariya/SPFx-Extensions/">Psspl Developers Flow</a></li>
                    </ul>
          ...
          if(!this._bottomPlaceholder){
            ...
            if(!this._bottomPlaceholder){
              console.error('PlaceHoder Value was not found..!');
              return;
            }
            if(this.properties){
              let bottomstring : string = this.properties.Bottom;
              if(!bottomstring){
                bottomstring = '(Bottom Value was not defined)';
              }
